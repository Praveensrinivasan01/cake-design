...
function chocolate() {
    ...
    aa.style.borderTopRightRadius='10px'
    aa.style.borderTopLeftRadius='10px'
...
function strawberry() {
    ...
    bb.style.borderTopRightRadius='10px'
    bb.style.borderTopLeftRadius='10px'
...
function butterscotch() {
    ...
    cc.style.borderTopRightRadius='10px'
    cc.style.borderTopLeftRadius='10px'
...
function vanilla() {
    ...
    dd.style.borderTopRightRadius='10px'
    dd.style.borderTopLeftRadius='10px'
...
function redvelvet() {
    ...
    ee.style.borderTopRightRadius='10px'
    ee.style.borderTopLeftRadius='10px'
...
function buy(){
    ...
    var img = new Image ()
    img.id = 'don'
    img.src = 'https://freepikpsd.com/file/2019/10/single-birthday-candle-png-1-Transparent-Images-Free.png'
    img.src = ' https://freepikpsd.com/file/2019/10/single-birthday-candle-png-1-Transparent-Images-Free.png'
